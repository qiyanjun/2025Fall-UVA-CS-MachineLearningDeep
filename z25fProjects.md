...
+ On the final presentation of your project: 
  - To minimize the overhead time cost (switching, wrong setup, ….), we will expect you to record a demo video to present your project, presentation contents including
    1. your project slide deck 
    2. your project iPython Notebook and you cell run it in the demo video
    3. Please practice the whole process for a few times before you make video demos. 
    4. we recommend you to submit your video demo to youtube and share the link in the Canvas project submission. 
